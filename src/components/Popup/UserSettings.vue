          ...
          <v-window v-model="tab">
            <v-window-item value="general">
              ...
              <v-row>
                <v-col cols="12">
                  <v-select
                    ...
                    @update:model-value="val => data!.user!.lang = val"
                  />
                </v-col>
              </v-row>
              <v-row>
              ...
              <v-row>
                <v-spacer />
                <v-col>
                  <v-btn variant="tonal" @click="exportData()">Export data</v-btn>
                </v-col>
                <v-col>
                  <v-btn variant="tonal" @click="importData()">Import data</v-btn>
                </v-col>
                <v-spacer />
              </v-row>
                ...
                <v-col>
                  <v-snackbar timeout="2000" color="primary" elevation="24">
                    <template #activator="{ props }">
                      <v-btn variant="tonal" v-bind="props" @click="resetTutorial()">
                        Reset Tutorial
                      </v-btn>
                    </template>
                    Tutorial resetted
            ...
            <v-window-item value="pomodoro">
              <v-row>
                ...
                <v-col cols="12">
                  <v-text-field
                    v-model.number="data!.pomodoro!.pomodoroFlexSettings!.numberOfBreak"
                    type="number"
                ...
                <v-col cols="12">
                  <v-text-field
                    v-model.number="data!.pomodoro!.pomodoroFlexSettings!.breakLength"
                    type="number"
